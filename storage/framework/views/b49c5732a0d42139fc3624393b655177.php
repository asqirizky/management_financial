						...
						<div class="d-flex flex-wrap flex-sm-nowrap mb-6">
							...
							<div class="flex-grow-1">
								...
								<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
									...
									<?php echo $__env->make('admin.Outflow.purchase', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
									<!--end::Actions-->
								</div>
								<!--end::Head-->
							</div>
								...
								<tbody class="fs-6">
									...
									<tr>
										...
										<td class="text-center pe-4">
											...
											<a href="<?php echo e(route('outflow.hapus', $item->id)); ?>" class="btn btn-light-danger btn-sm delete-button">
