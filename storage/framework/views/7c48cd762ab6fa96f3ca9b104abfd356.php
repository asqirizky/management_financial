...
<div class="modal fade" id="kt_modal_add_planning" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            <!--begin:Form-->
            <form class="form" method="POST" action="<?php echo e(route('plan.store')); ?>">
                <?php echo csrf_field(); ?>
                <!--begin::Heading-->
                ...
                <div class="mb-8 fv-row">
                    <!--begin::Label-->
                    <label class="mb-2 required fw-semibold fs-6">Item</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                        <input type="text" class="form-control form-control-lg" name="item" placeholder="Item" required>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="mb-8 fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                        <input type="number" class="form-control form-control-lg" name="price" placeholder="Price" required>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="mb-8 fv-row">
					...
					<select name="category" class="form-select" data-control="select2" data-hide-search="true" required>
                        ...
                        <option value="Tertiery">Tertiery</option>
                    </select>
					<!--end::Input-->
                </div>
                <!--end::Input group-->
...
<?php /**PATH /var/www/html/resources/views/admin/Plan/add_plan.blade.php ENDPATH**/ ?>