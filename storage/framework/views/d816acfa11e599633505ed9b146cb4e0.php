...
<div class="modal fade" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="<?php echo e(route('inflow.store')); ?>">
                <?php echo csrf_field(); ?>
                <!--begin::Heading-->
...
<?php /**PATH /var/www/html/resources/views/admin/Inflow/tambah_inflow.blade.php ENDPATH**/ ?>