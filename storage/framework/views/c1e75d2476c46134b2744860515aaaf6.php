...
<div class="modal fade" id="kt_modal_edit_details<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_edit_form" class="form" method="POST" enctype="multipart/form-data" action="<?php echo e(route('outflow.update', $item->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-8 fv-row">
                    <label class="mb-2 required fw-semibold fs-6">Item/Nama Barang</label>
                        <input type="text" class="form-control form-control-lg" name="item_jenis_barang" placeholder="Item/Nama Barang" value="<?php echo e($item->item_jenis_barang); ?>" required>
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="mb-8 fv-row">
                    <label class="mb-2 required fw-semibold fs-6">Quantity</label>
                        <input type="number" class="form-control form-control-lg" name="quantity" placeholder="Quantity" value="<?php echo e($item->quantity); ?>" required>
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="mb-8 fv-row">
                    <label class="mb-2 required fw-semibold fs-6">Harga Satuan</label>
                        <input type="text" class="form-control form-control-lg" name="harga_satuan" value="<?php echo e(number_format($item->harga_satuan, 0, ',', '.')); ?>" placeholder="Harga Satuan" required>
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="mb-8 fv-row">
                    <label class="mb-2 required fw-semibold fs-6">Tanggal Pembelian</label>
                        <input type="date" class="form-control form-control-lg" name="tanggal_pembelian" value="<?php echo e($item->tanggal_pembelian); ?>" placeholder="Tanggal Pembelian" required>
                </div>
                <!--end::Input group-->
                <!--begin::Actions-->
...
<?php /**PATH /var/www/html/resources/views/admin/Outflow/edit_transaksi.blade.php ENDPATH**/ ?>