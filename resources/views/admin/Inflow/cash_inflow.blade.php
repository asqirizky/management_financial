								...
								<tbody class="fs-6">
									...
									<tr>
										...
										<td class="text-center pe-4">
											<a type="button" class="btn btn-center btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_details" data-id="{{ $item->id }}" data-nominal="{{ $item->nominal }}" data-sumber_dana="{{ $item->sumber_dana }}" data-keterangan="{{ $item->keterangan }}" data-tanggal_masuk="{{ $item->tanggal_masuk }}">
												<i class="ki-outline ki-pencil fs-2"></i> Edit
											</a>
											<a href="{{ route('inflow.hapus', $item->id) }}" type="submit" class="btn btn-center btn-light-danger btn-sm delete-button">
